...
class pathFinder:
    ...
    def get_file_path_with_wildcard_from_gdb(self, wildcard=None, data_type=None):
        ...
        if data_type =='Table':
            ...
            fc = arcpy.ListFeatureClasses(wildcard, feature_type=data_type)
        fc_list_path = []
    ...
    @classmethod
    def return_merged_tables_from_fc_list(cls, in_gdb, field):

        fc_list = pathFinder(env_0=in_gdb).get_path_for_all_feature_from_gdb(type='POLYLINE')
        df_list=[]
        for x in fc_list:
